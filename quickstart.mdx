...
<Card title="Context MCP Overview" icon="book-open" href="/documentation/overview">
  Review capabilities, transport details, and supported tools.
</Card>

<Card title="Recommended Workflows" icon="shuffle" href="/documentation/workflows">
  Follow battle-tested sequences for indexing and searching.
</Card>

<Card title="Indexing Guide" icon="database" href="/documentation/indexing-guide">
  Deep dive on `index-content` parameters and usage tips.
</Card>

<Card title="Search Guide" icon="magnifying-glass" href="/documentation/search-guide">
  Learn how to craft effective semantic queries with `search-content`.
</Card>
